...
{ 
    ...
    EXECUTEFAST() {                     
        ...
        FAST_50ms() {   // We process the logic and relevant input and output every 50 milliseconds
            ...
            LowDigIn(P12, Souliss_T1n_ToggleCmd, L14); 
            LowDigIn(P13, Souliss_T1n_ToggleCmd, L16); 
            LowDigIn(P14, Souliss_T1n_ToggleCmd, L14); 
            LowDigIn(P15, Souliss_T1n_ToggleCmd, L19); 
            ...
            DigIn(in_IR11, Souliss_T1n_OnCmd, IR11); 
            LowDigIn(in_IR11, Souliss_T1n_OffCmd, IR11);
            DigIn(in_IR12, Souliss_T1n_OnCmd, IR12); 
            LowDigIn(in_IR12, Souliss_T1n_OffCmd, IR12); 
            DigIn(in_IR13, Souliss_T1n_OnCmd, IR13); 
            LowDigIn(in_IR13, Souliss_T1n_OffCmd, IR13);
